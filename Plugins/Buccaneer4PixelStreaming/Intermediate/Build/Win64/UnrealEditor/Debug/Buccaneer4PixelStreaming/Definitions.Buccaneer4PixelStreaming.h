#undef BUCCANEER4PIXELSTREAMING_API
...
#define UE_MODULE_NAME "Buccaneer4PixelStreaming"
#define UE_PLUGIN_NAME "Buccaneer4PixelStreaming"
...
#define DDPI_EXTRA_SHADERPLATFORMS SP_XBOXONE_SM6=34, SP_XSX_SM6=35, SP_PS4=36, SP_PS5=33, SP_GLSL_SWITCH=38, SP_GLSL_SWITCH_MOBILE=39, 
#define DDPI_SHADER_PLATFORM_NAME_MAP { TEXT("XBOXONE_SM6"), TEXT("XB1"), SP_XBOXONE_SM6 },{ TEXT("XSX_SM6"), TEXT("XSX"), SP_XSX_SM6 },{ TEXT("PS4"), TEXT("PS4"), SP_PS4 },{ TEXT("PS5"), TEXT("PS5"), SP_PS5 },{ TEXT("GLSL_SWITCH"), TEXT("Switch"), SP_GLSL_SWITCH },{ TEXT("GLSL_SWITCH_MOBILE"), TEXT("Switch"), SP_GLSL_SWITCH_MOBILE },
...
#define WEBRTC_WIN 1
#define WEBRTC_VERSION 84
#define ABSL_ALLOCATOR_NOTHROW 1
#define BUCCANEERCOMMON_API DLLIMPORT
#define BUCCANEER4PIXELSTREAMING_API DLLEXPORT
