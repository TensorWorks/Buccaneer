...
#define DDPI_EXTRA_SHADERPLATFORMS SP_PS4=36, SP_GLSL_SWITCH=38, SP_GLSL_SWITCH_MOBILE=39, SP_XBOXONE_D3D12=37, 
#define DDPI_SHADER_PLATFORM_NAME_MAP { TEXT("PS4"), TEXT("PS4"), SP_PS4 },{ TEXT("GLSL_SWITCH"), TEXT("Switch"), SP_GLSL_SWITCH },{ TEXT("GLSL_SWITCH_MOBILE"), TEXT("Switch"), SP_GLSL_SWITCH_MOBILE },{ TEXT("XBOXONE_D3D12"), TEXT("XboxOne"), SP_XBOXONE_D3D12 },
